            ...
            <tbody>
                <?php
                    ...
                    if(isset($_POST['search']) && $_POST['search']!=" "){
                        ...
                        $sel_supplier = "SELECT * FROM nhacungcap WHERE TenNCC LIKE '%$valueSearch%' OR DienThoaiNCC LIKE '%$valueSearch%' OR EmailNCC LIKE '%$valueSearch%'";
                    }
                    else{
                    ...
                    <div class="ele">
                        <tr style="font-size: 14px;">
                            ...
                            <td class="col-3 text-center">
                                <p class="mb-0"><b><?php echo $rowData['TenNCC'];?></b></p>
                            </td>
                            <td class="col-3 text-center">
                                <p class="mb-0"><b><?php echo $rowData['DienThoaiNCC'];?></b></p>
                            </td>
                            <td class="col-3 text-center">
                                <p class="mb-0"><b><?php echo $rowData['EmailNCC'];?></b></p>
                            </td>
                            <td class="col-2 text-center">
                                <ul class="action-list " style="list-style: none; font-size:15px;">
                                    <li class="d-inline-block"><a href="Supplier_del.php?id=<?php echo $rowData['MaNCC'];?>" class="btn btn-danger"><i class="fa fa-times"></i></a></li>
                                </ul>
                            </td>
                        </tr>
                    </div>
    ...
    <div class="staff-root hidden">
        <div class="staff container text-center ">
            <form method="POST" action="Supplier_add.php">
                    ...
                    <h1 style="font-weight: 700;">THÊM NHÀ CUNG CẤP</h1>
                    <div class="form-group d-flex align-items-center justify-content-center">
                        <input type="text" class="form-control" id="Supplier" placeholder="Tên nhà cung cấp" name="supplier_name" required>
                    </div>
                    <div class="form-group d-flex align-items-center justify-content-center">
                        <input type="text" class="form-control" id="SupplierPhone" placeholder="Số điện thoại" name="supplier_phone" required>
                    </div>
                    <div class="form-group mb-3 d-flex align-items-center justify-content-center">
                        <input type="text" class="form-control" id="SupplierEmail" placeholder="Email" name="supplier_email" required>
                    </div>
