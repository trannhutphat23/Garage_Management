...
<body>
        ...
        <table class="table table-responsive table-striped ">
            <thead>
                <tr>
                    ...
                    <th class="col-5 text-center">Tên tiền công</th>
                    <th class="col-4 text-center">Giá tiền</th>
                    <th class="col-2"></th>
                </tr>
            </thead>
            <tbody>
                <?php
                    ...
                    if(isset($_POST['search']) && $_POST['search']!=" "){
                        ...
                        $sel_cost = "SELECT * FROM tiencong WHERE TenTienCong LIKE '%$valueSearch%'";
                    }
                    else{
                    ...
                    <div class="ele">
                        <tr style="font-size: 14px;">
                            ...
                            <td class="col-3 text-center">
                                <p class="mb-0"><b><?php echo $rowData['TenTienCong']; ?></b></p>
                            </td>
                            <td class="col-3 text-center">
                                <p class="mb-0"><b><?php echo $rowData['GiaTienCong']; ?></b></p>
                            </td>
                            <td class="col-2 text-center">
                                <ul class="action-list " style="list-style: none; font-size:15px;">
                                    <li class="d-inline-block"><a href="Cost_del.php?id=<?php echo $rowData['MaTC']; ?>" class="btn btn-danger"><i class="fa fa-times"></i></a></li>
                                </ul>
                            </td>
                        </tr>
                    </div>
    ...
    <div class="staff-root hidden">
        <div class="staff container text-center ">
            <form method="POST" action="Cost_add.php">
                <i class="fa-sharp fa-solid fa-square-xmark cancel" onclick="Staff()"></i>
                <h1 style="font-weight: 700;">THÊM TÊN TIỀN CÔNG</h1>
                <div class="form-group mb-3 d-flex align-items-center justify-content-center">
                    <input style="width: 60%; margin-right: 10px;" type="text" class="form-control" id="Cost" placeholder="Tên tiền công" name="CostName" required>
                    <input  style="width: 30%;" type="number" min="1" step="any" class="form-control" id="SuppliesCost" placeholder="Giá tiền" name="CostValue" required>
                </div>
